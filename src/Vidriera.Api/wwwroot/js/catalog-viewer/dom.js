...
export const dom = {
    ...
    currentProductAdd: document.getElementById("current-product-add"),
    currentProductName: document.getElementById("current-product-name"),
    currentProductStepper: document.getElementById("current-product-stepper"),
