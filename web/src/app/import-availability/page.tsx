...
import { useImportAvailability } from "./hooks/useImportAvailability";
import { ImportAvailabilityPanel } from "./components/ImportAvailabilityPanel";
...
export default function ImportAvailabilityPage() {
  ...
  const { isImporting, result, handleImport, handleDownloadTemplate } = useImportAvailability({ auth, setError });
